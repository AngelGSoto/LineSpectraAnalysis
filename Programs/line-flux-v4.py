...
#Find the lines
lines = find_lines_derivative(spec_sub, flux_threshold=0.1e-17)

mask = lines["line_type"] == "emission"
lines_emiss = lines[mask]
...
for line in lines_emiss["line_center"]:
    line_region_ = SpectralRegion(line - 6 * u.AA, line + 6 * u.AA)
