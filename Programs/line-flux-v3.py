...
sub_region = SpectralRegion(4900*u.AA, 9000*u.AA)
...
sub_region_blue = SpectralRegion(4900*u.AA, 5800*u.AA)
sub_region_red = SpectralRegion(5800*u.AA, 9000*u.AA)
sub_spectrum_blue = extract_region(spec_sub, sub_region_blue)
sub_spectrum_red = extract_region(spec_sub, sub_region_red)

#Find the lines
lines_blue = find_lines_derivative(sub_spectrum_blue, flux_threshold=-1.2e-16)
lines_red = find_lines_derivative(sub_spectrum_red, flux_threshold=0.1e-16)
